...
Create new column with more than 1 condition. Assuming we want to flag dataset that having Sepal.Length > 5 & Petal.Length > 5. If this observation is met, logical TRUE value will be returned in new column of "sepal_petal_mt_5"
